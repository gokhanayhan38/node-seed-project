...
class DataGrid extends Component {
    constructor(props={} /*: object*/, context={} /*: object*/){
        ...
        this.getSize = this.getSize(this);
        this.getColumns = this.getColumns(this);
        this.handleGridRowsUpdated = this.handleGridRowsUpdated(this);
        this.handleAddRow = this.handleAddRow(this);
        this.getRowAt = this.getRowAt(this);
    }
